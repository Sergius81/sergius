...
```shell
git clone https://github.com/Sergius81/sergius
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/sergius/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://Sergius81.github.io/sergius'
title: 'Qubt Theme'
```
...
`https://Sergius81.github.io/sergius`